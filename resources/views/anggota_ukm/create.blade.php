...
<div class="wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Daftar Anggota UKM</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
  ...
  <!-- Main content -->
  <form action="{{ route('anggota_ukm.store') }}" method="POST">
  @csrf
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="id_mahasiswa" id="id_mahasiswa" class="form-control @error('id_mahasiswa') is-invalid @enderror">
