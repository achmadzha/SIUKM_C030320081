...
<div class="wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Unit Kegiatan Mahasiswa</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama" id="nama" placeholder="Ketikan Nama UKM">
                      @error('nama')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="deskripsi" id="deskripsi" placeholder="Ketikan Deskripsi UKM">
                      @error('deskripsi')
                      <span class="badge badge-danger"><small>{{ $message }}</small></span>
                      @enderror
                    </div>
